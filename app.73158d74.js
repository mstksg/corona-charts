...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../../../.nvm/versions/node/v12.11.1/lib/node_modules/parcel/node_modules/process/browser.js":[function(require,module,exports) {
...
(function ($PS) {
  ...
  var eqEquiv = new Data_Eq.Eq(function (v) {
    return function (v1) {
      return true;
    };
  });
...
(function ($PS) {
  ...
  var toOrdering = function toOrdering(v) {
    ...
    ;
    throw new Error("Failed pattern match at Type.GCompare (line 19, column 14 - line 22, column 16): " + [v.constructor.name]);
  };

  var mkWrEx = function mkWrEx($16) {
    return WrEx(Data_Exists.mkExists($16));
  };
...
(function ($PS) {
  ...
  var toNType = function toNType(v) {
    ...
    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 177, column 11 - line 183, column 37): " + [v.constructor.name]);
  };
  ...
  var showSType = new Data_Show.Show(function (v) {
    ...
    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 133, column 12 - line 138, column 31): " + [v.constructor.name]);
  });
  ...
  var sTypeIx = function sTypeIx(v) {
    ...
    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 143, column 11 - line 148, column 20): " + [v.constructor.name]);
  };
  ...
  var percentShow = new Data_Show.Show(function (v) {
    return Data_Show.show(Data_Show.showNumber)(v * Data_Int.toNumber(100)) + "%";
  });
  ...
  var percentCRing = new Data_CommutativeRing.CommutativeRing(function () {
    return percentRing;
  });
  var percentERing = new Data_EuclideanRing.EuclideanRing(function () {
    return percentCRing;
  }, function (v) {
  ...
  var nTypeSubtract = function nTypeSubtract(v) {
    ...
    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 192, column 17 - line 195, column 66): " + [v.constructor.name]);
  };

  var nTypeShow = function nTypeShow(v) {
    if (v instanceof NInt) {
      var $181 = Data_Show.show(Data_Show.showInt);
      var $182 = Type_Equiv.equivTo(v.value0);
      return function ($183) {
        return $181($182($183));
      };
    }
    ...
    if (v instanceof NNumber) {
      var $184 = Data_Show.show(Data_Show.showNumber);
    ...
    if (v instanceof NPercent) {
      var $187 = Data_Show.show(percentShow);
    ...
    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 204, column 13 - line 207, column 37): " + [v.constructor.name]);
  };

  var nTypeNumber = function nTypeNumber(v) {
    if (v instanceof NInt) {
      var $190 = Type_Equiv.equivTo(v.value0);
      return function ($191) {
        return Data_Int.toNumber($190($191));
      };
    }
    ...
    if (v instanceof NPercent) {
      var $192 = Type_Equiv.equivTo(v.value0);
      return function ($193) {
        return unPercent($192($193));
      };
    }

    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 186, column 15 - line 189, column 42): " + [v.constructor.name]);
  };
  ...
  var handle1Scale = new Type_Handler.Handle1(function (v) {
    ...
    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 327, column 15 - line 330, column 51): " + [v.constructor.name]);
  }, function (v) {
    return v({
      date: $$Date.create,
  ...
  var handle1SType = new Type_Handler.Handle1(function (v) {
    ...
    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 346, column 15 - line 351, column 54): " + [v.constructor.name]);
  }, function (v) {
    return v({
      day: SDay.create,
      days: SDays.create,
  ...
  var gshowScale = new Type_GCompare.GShow(function (v) {
    ...
    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 249, column 13 - line 252, column 24): " + [v.constructor.name]);
  });
  ...
  var fromNType = function fromNType(v) {
    ...
    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 170, column 13 - line 174, column 29): " + [v.constructor.name]);
  };
  ...
  var nTypeCompare = function nTypeCompare(v) {
    if (v instanceof NInt) {
      return function (x) {
        return function (y) {
    ...
    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 198, column 16 - line 201, column 62): " + [v.constructor.name]);
  };
  ...
  var decideSType = new Type_Equiv.Decide(function (v) {
    ...
    ;
    throw new Error("Failed pattern match at D3.Scatter.Type (line 99, column 14 - line 114, column 28): " + [v.constructor.name]);
  });
  ...
  var gordSType = new Type_GCompare.GOrd(function () {
    ...
    return function (y) {
      ...
      if (v instanceof Data_Maybe.Nothing) {
        ...
        ;
        throw new Error("Failed pattern match at D3.Scatter.Type (line 121, column 20 - line 124, column 18): " + [v1.constructor.name]);
      }

      ;
      throw new Error("Failed pattern match at D3.Scatter.Type (line 119, column 20 - line 124, column 18): " + [v.constructor.name]);
    };
  });
  exports["SDay"] = SDay;
  exports["SInt"] = SInt;
  ...
  exports["nTypeCompare"] = nTypeCompare;
  exports["nTypeShow"] = nTypeShow;
  exports["nInt"] = nInt;
  exports["Date"] = $$Date;
  exports["Linear"] = Linear;
  exports["Log"] = Log;
  exports["runNScale"] = runNScale;
  exports["percentSemiring"] = percentSemiring;
  exports["percentERing"] = percentERing;
...
(function ($PS) {
  ...
  var ntDay = new Data_Newtype.Newtype(function (n) {
    return n;
  }, Day);
  ...
  var fromJSDate = function () {
    var $24 = Data_Functor.map(Data_Maybe.functorMaybe)(fromDate);
    return function ($25) {
      return $24(Data_JSDate.toDate($25));
    };
  }();
...
(function ($PS) {
  ...
  var zipDated = function zipDated(f) {
    return function (v) {
      return function (v1) {
        ...
        ;
        throw new Error("Failed pattern match at Data.Dated (line 49, column 42 - line 52, column 90): " + [v2.constructor.name]);
      };
    };
  };
  ...
  var mapMaybe = function mapMaybe(f) {
    return function (v) {
      var chompTrue = function chompTrue(i0) {
        return function (y) {
          var go = function go($copy_i) {
            return function ($copy_ys) {
              return function ($copy_v1) {
                var $tco_var_i = $copy_i;
                var $tco_var_ys = $copy_ys;
                var $tco_done = false;
                var $tco_result;

                function $tco_loop(i, ys, v1) {
                  if (v1 instanceof Data_List_Types.Nil) {
                    $tco_done = true;
                    return Data_List_Lazy.singleton({
                      start: i0,
                      values: ys
                    });
                  }
                  ...
                  if (v1 instanceof Data_List_Types.Cons) {
                    ...
                    if (v2 instanceof Data_Maybe.Just) {
                      $tco_var_i = i + 1 | 0;
                      $tco_var_ys = Data_Semigroup.append(Data_Semigroup.semigroupArray)(ys)([v2.value0]);
                      $copy_v1 = v1.value1;
                      return;
                    }
                    ...
                    if (v2 instanceof Data_Maybe.Nothing) {
                      $tco_done = true;
                      return Data_List_Lazy_Types.cons({
                        start: i0,
                        values: ys
                      })(chompFalse((i0 + i | 0) + 1 | 0)(v1.value1));
                    }

                    ;
                    throw new Error("Failed pattern match at Data.Dated (line 95, column 26 - line 99, column 45): " + [v2.constructor.name]);
                  }

                  ;
                  throw new Error("Failed pattern match at Data.Dated (line 90, column 19 - line 99, column 45): " + [v1.constructor.name]);
                }

                ;

                while (!$tco_done) {
                  $tco_result = $tco_loop($tco_var_i, $tco_var_ys, $copy_v1);
                }
      ...
      var chompFalse = function chompFalse($copy_i) {
        return function ($copy_v1) {
          var $tco_var_i = $copy_i;
          var $tco_done = false;
          var $tco_result;
          ...
          function $tco_loop(i, v1) {
            ...
            if (v1 instanceof Data_List_Types.Cons) {
              ...
              if (v2 instanceof Data_Maybe.Just) {
                $tco_done = true;
                return chompTrue(i)(v2.value0)(v1.value1);
              }

              ;
              throw new Error("Failed pattern match at Data.Dated (line 83, column 22 - line 85, column 36): " + [v2.constructor.name]);
            }

            ;
            throw new Error("Failed pattern match at Data.Dated (line 81, column 20 - line 85, column 36): " + [v1.constructor.name]);
          }
      ...
      return chompFalse(Data_Newtype.unwrap(Data_ModifiedJulianDay.ntDay)(v.start))(Data_List.fromFoldable(Data_Foldable.foldableArray)(v.values));
    };
  };
...
(function ($PS) {
  ...
  var DaysSince = function () {
    function DaysSince(value0, value1, value2) {
      this.value0 = value0;
      this.value1 = value1;
      this.value2 = value2;
    }
    ...
    DaysSince.create = function (value0) {
      return function (value1) {
        return function (value2) {
          return new DaysSince(value0, value1, value2);
        };
      };
    };
  ...
  var windows = function windows(n) {
    var go = function go(xs) {
      return function (x) {
        ...
        ;
        throw new Error("Failed pattern match at Corona.Chart (line 270, column 15 - line 272, column 55): " + [v.constructor.name]);
      };
    };
    ...
    return function (v) {
      ...
      ;
      throw new Error("Failed pattern match at Corona.Chart (line 262, column 13 - line 267, column 19): " + [v.constructor.name]);
    };
  };

  var withWindow = function withWindow(n) {
    return function (f) {
      var $272 = Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray);
      var $273 = Data_Functor.map(Data_List_Types.functorList)(f);
      var $274 = windows(n);
      var $275 = Data_List.fromFoldable(Data_Foldable.foldableArray);
      return function ($276) {
        return $272($273($274($275($276))));
      };
    };
  };
  ...
  var toFractionalOut = function toFractionalOut(v) {
    if (v instanceof I2N) {
      return new D3_Scatter_Type.SNumber(v.value1);
    }
    ...
    if (v instanceof P2P) {
      return new D3_Scatter_Type.SPercent(v.value1);
    }

    ;
    throw new Error("Failed pattern match at Corona.Chart (line 163, column 19 - line 166, column 26): " + [v.constructor.name]);
  };
  ...
  var toFractional = function toFractional(v) {
    ...
    ;
    throw new Error("Failed pattern match at Corona.Chart (line 152, column 16 - line 155, column 37): " + [v.constructor.name]);
  };
  ...
  var percentGrowth = function percentGrowth(x) {
    return function (y) {
      ...
      ;
      throw new Error("Failed pattern match at Corona.Chart (line 228, column 1 - line 231, column 15): " + [x.constructor.name, y.constructor.name]);
    };
  };

  var gshowCondition = function gshowCondition(nt) {
    return function (v) {
      if (v instanceof AtLeast) {
        return "AtLeast " + D3_Scatter_Type.nTypeShow(nt)(v.value0);
      }

      ;

      if (v instanceof AtMost) {
        return "AtMost " + D3_Scatter_Type.nTypeShow(nt)(v.value0);
      }

      ;
      throw new Error("Failed pattern match at Corona.Chart (line 184, column 21 - line 186, column 48): " + [v.constructor.name]);
    };
  };
  ...
  var gshowBase = new Type_GCompare.GShow(function (v) {
    ...
    ;
    throw new Error("Failed pattern match at Corona.Chart (line 71, column 13 - line 75, column 33): " + [v.constructor.name]);
  });
  ...
  var showProjection = new Data_Show.Show(Type_GCompare.gshow(gshowProjection));
  var gshow2Operation = new Type_GCompare.GShow2(function (v) {
    ...
    if (v instanceof DaysSince) {
      return Type_DSum.withDSum(v.value2)(function (t) {
        return function (v1) {
          return "DaysSince (" + (Data_Show.show(showProjection)(v1.value0) + (") (" + (gshowCondition(t)(v1.value1) + ")")));
        };
      });
    }

    ;
    throw new Error("Failed pattern match at Corona.Chart (line 203, column 14 - line 209, column 12): " + [v.constructor.name]);
  });
  var functorCondition = new Data_Functor.Functor(function (f) {
    return function (v) {
      ...
      ;
      throw new Error("Failed pattern match at Corona.Chart (line 174, column 13 - line 176, column 32): " + [v.constructor.name]);
    };
  });
  ...
  var eqBase = new Data_Eq.Eq(function (x) {
    return function (y) {
      if (x instanceof Time && y instanceof Time) {
        return Data_Eq.eq(Type_Equiv.eqEquiv)(x.value0)(y.value0);
      }
      ...
      if (x instanceof Deaths && y instanceof Deaths) {
        return Data_Eq.eq(Type_Equiv.eqEquiv)(x.value0)(y.value0);
      }

      ;

      if (x instanceof Recovered && y instanceof Recovered) {
        return Data_Eq.eq(Type_Equiv.eqEquiv)(x.value0)(y.value0);
      }
  ...
  var decideBaseProjection = new Type_Equiv.Decide(function (v) {
    ...
    ;
    throw new Error("Failed pattern match at Corona.Chart (line 89, column 14 - line 101, column 27): " + [v.constructor.name]);
  });
  ...
  var conditionValue = function conditionValue(v) {
    ...
    ;
    throw new Error("Failed pattern match at Corona.Chart (line 189, column 18 - line 191, column 19): " + [v.constructor.name]);
  };

  var conditionLabel = function conditionLabel(nt) {
    return function (v) {
      if (v instanceof AtLeast) {
        return "at least " + D3_Scatter_Type.nTypeShow(nt)(v.value0);
      }

      ;

      if (v instanceof AtMost) {
        return "at most " + D3_Scatter_Type.nTypeShow(nt)(v.value0);
      }

      ;
      throw new Error("Failed pattern match at Corona.Chart (line 369, column 21 - line 371, column 46): " + [v.constructor.name]);
    };
  };
  ...
  var baseType = function baseType(v) {
    ...
    ;
    throw new Error("Failed pattern match at Corona.Chart (line 62, column 12 - line 66, column 32): " + [v.constructor.name]);
  };
      ...
      return Type_DSum.withDSum(dp)(function (tB) {
        return function (spr) {
          return withProjection(spr)(function (pr) {
            ...
            ;
            throw new Error("Failed pattern match at Corona.Chart (line 424, column 13 - line 432, column 18): " + [v.constructor.name]);
          });
        };
      });
    };
  ...
  var baseProjectionLabel = function baseProjectionLabel(v) {
    ...
    ;
    throw new Error("Failed pattern match at Corona.Chart (line 353, column 23 - line 357, column 37): " + [v.constructor.name]);
  };
  ...
  var operationLabel = function operationLabel(v) {
    ...
    if (v instanceof DaysSince) {
      return Type_DSum.withDSum(v.value2)(function (t) {
        return function (v1) {
          return "Days since " + (projectionLabel(v1.value0) + (" is " + (conditionLabel(t)(v1.value1) + " for")));
        };
      });
    }

    ;
    throw new Error("Failed pattern match at Corona.Chart (line 360, column 18 - line 366, column 10): " + [v.constructor.name]);
  };
  ...
  var baseProjection = function baseProjection(pr) {
    return withProjection(pr)(function ($277) {
  ...
  var applyCondition = function applyCondition(nt) {
    return function (v) {
      if (v instanceof AtLeast) {
        return function (x) {
          return Data_Eq.eq(Data_Ordering.eqOrdering)(D3_Scatter_Type.nTypeCompare(nt)(x)(v.value0))(Data_Ordering.GT.value);
        };
      }
      ...
      if (v instanceof AtMost) {
        return function (x) {
          return Data_Eq.eq(Data_Ordering.eqOrdering)(D3_Scatter_Type.nTypeCompare(nt)(x)(v.value0))(Data_Ordering.LT.value);
        };
      }

      ;
      throw new Error("Failed pattern match at Corona.Chart (line 324, column 21 - line 326, column 49): " + [v.constructor.name]);
    };
  };
  ...
  var applyBaseProjection = function applyBaseProjection(v) {
    ...
    ;
    throw new Error("Failed pattern match at Corona.Chart (line 333, column 23 - line 337, column 61): " + [v.constructor.name]);
  };

  var applyProjection = function applyProjection(spr) {
    return function (allDat) {
      return withProjection(spr)(function (pr) {
        var $278 = Type_Chain.runChain(applyOperation(allDat))(pr.operations);
        var $279 = applyBaseProjection(pr.base);
        return function ($280) {
          return $278($279($280));
        };
      })(allDat);
  ...
  var applyOperation = function applyOperation(env) {
    return function (v) {
      if (v instanceof Delta) {
        return function (v1) {
          return {
      ...
      if (v instanceof Window) {
        return function (v1) {
          return {
            ...
            values: function () {
              if (v.value0 instanceof I2N) {
                return withWindow(v.value1)(function (ys) {
                  return Type_Equiv.equivFrom(v.value0.value1)(Data_Int.toNumber(Data_Foldable.sum(Data_Sequence_NonEmpty.foldableSeq)(Data_Semiring.semiringInt)(Data_Functor.map(Data_Sequence_NonEmpty.functorSeq)(Type_Equiv.equivTo(v.value0.value0))(ys))) / Data_Int.toNumber((v.value1 * 2 | 0) + 1 | 0));
                })(v1.values);
              }

              ;

              if (v.value0 instanceof N2N) {
                return withWindow(v.value1)(function (ys) {
                  return Type_Equiv.equivFrom(v.value0.value1)(Data_Foldable.sum(Data_Sequence_NonEmpty.foldableSeq)(Data_Semiring.semiringNumber)(Data_Functor.map(Data_Sequence_NonEmpty.functorSeq)(Type_Equiv.equivTo(v.value0.value0))(ys)) / Data_Int.toNumber((v.value1 * 2 | 0) + 1 | 0));
                })(v1.values);
              }

              ;

              if (v.value0 instanceof P2P) {
                return withWindow(v.value1)(function (ys) {
                  return Type_Equiv.equivFrom(v.value0.value1)(Data_EuclideanRing.div(D3_Scatter_Type.percentERing)(Data_Foldable.sum(Data_Sequence_NonEmpty.foldableSeq)(D3_Scatter_Type.percentSemiring)(Data_Functor.map(Data_Sequence_NonEmpty.functorSeq)(Type_Equiv.equivTo(v.value0.value0))(ys)))(Data_Int.toNumber((v.value1 * 2 | 0) + 1 | 0)));
                })(v1.values);
              }

              ;
              throw new Error("Failed pattern match at Corona.Chart (line 297, column 19 - line 309, column 29): " + [v.value0.constructor.name]);
            }()
          };
        };
      }
      ...
      if (v instanceof DaysSince) {
        return function (v1) {
          return Type_DSum.withDSum(v.value2)(function (nt) {
            return function (v2) {
              var refDat = applyProjection(v2.value0)(env);
              var emptyDated = {
                start: v1.start,
                values: []
              };
              return Data_Maybe.maybe(emptyDated)(Type_Equiv.equivFromF(v.value1))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Dated.findIndex(applyCondition(nt)(v2.value1))(refDat))(function (v3) {
                return Data_List_Lazy.head(Data_Function.flip(Data_Dated.mapMaybe)(Type_Equiv.equivToF(v.value0)(v1))(function (v4) {
                  var daysSince = v4 - v3 | 0;
                  var $266 = daysSince >= 0;

                  if ($266) {
                    return new Data_Maybe.Just(daysSince);
                  }
      ...
      ;
      throw new Error("Failed pattern match at Corona.Chart (line 280, column 22 - line 321, column 6): " + [v.constructor.name]);
    };
  };
...
(function ($PS) {
  ...
  $PS["Corona.Chart.UI.DateOp"] = $PS["Corona.Chart.UI.DateOp"] || {};
  var exports = $PS["Corona.Chart.UI.DateOp"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var SetCond = function () {
    function SetCond(value0) {
      this.value0 = value0;
    }

    ;

    SetCond.create = function (value0) {
      return new SetCond(value0);
    };
  ...
  var SetLimit = function () {
    function SetLimit(value0) {
      this.value0 = value0;
    }

    ;

    SetLimit.create = function (value0) {
      return new SetLimit(value0);
    };

    return SetLimit;
  }();

  var intBaseProjections = [Corona_Chart.bConfirmed, Corona_Chart.bDeaths, Corona_Chart.bRecovered];

  var initialState = function initialState(v) {
    return {
      baseProjection: Corona_Chart.bConfirmed,
      condition: new Corona_Chart.AtLeast(100)
    };
  };

  var handleAction = function handleAction(act) {
    return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(function () {
      ...
      if (act instanceof SetCond) {
        return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
          ...
          ;
          $14.condition = Data_Functor.voidRight(Corona_Chart.functorCondition)(Corona_Chart.conditionValue(st.condition))(act.value0);
          return $14;
        });
      }
      ...
      if (act instanceof SetLimit) {
        return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
          ...
          ;
          $18.condition = Data_Functor.voidRight(Corona_Chart.functorCondition)(act.value0)(st.condition);
          return $18;
        });
      }

      ;
      throw new Error("Failed pattern match at Corona.Chart.UI.DateOp (line 123, column 5 - line 128, column 45): " + [act.constructor.name]);
    }())(function () {
      return Halogen_Query_HalogenM.raise(new ChangeEvent(Data_Exists.mkExists(D3_Scatter_Type.sDays)));
    });
  };

  var assembleOp = Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
    var pr = Corona_Chart.projection({
      base: st.baseProjection,
      operations: Type_Chain.nil
    });
    return Type_DSum.dsum(D3_Scatter_Type.sDays)(new Corona_Chart.DaysSince(Type_Equiv.refl, Type_Equiv.refl, Type_DSum.dsum(D3_Scatter_Type.nInt)(new Data_Tuple.Tuple(pr, st.condition))));
  });

  var handleQuery = function handleQuery(v) {
    return Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(function ($29) {
      return Data_Maybe.Just.create(v.value0($29));
    })(assembleOp);
  };

  var allCondType = [new Corona_Chart.AtLeast(Data_Unit.unit), new Corona_Chart.AtMost(Data_Unit.unit)];

  var render = function render(st) {
    var indexToCond = function indexToCond(v) {
      if (v === 0) {
        return new Data_Maybe.Just(new Corona_Chart.AtLeast(Data_Unit.unit));
      }

      ;

      if (v === 1) {
        return new Data_Maybe.Just(new Corona_Chart.AtMost(Data_Unit.unit));
      }
    ...
    var indexToBase = function indexToBase(v) {
      if (v === 0) {
        return new Data_Maybe.Just(Corona_Chart.bConfirmed);
      }

      ;

      if (v === 1) {
        return new Data_Maybe.Just(Corona_Chart.bDeaths);
      }

      ;

      if (v === 2) {
        return new Data_Maybe.Just(Corona_Chart.bRecovered);
      }
    ...
    var condString = function condString(v) {
      ...
      ;
      throw new Error("Failed pattern match at Corona.Chart.UI.DateOp (line 103, column 18 - line 105, column 38): " + [v.constructor.name]);
    };

    return Halogen_HTML_Elements.div([Halogen_Util.classProp("date-op")])([Halogen_HTML_Elements.div([Halogen_Util.classProp("date-picker")])([Halogen_HTML_Elements.select_([Halogen_HTML_Elements.option_([Halogen_HTML_Core.text("Days since...")])])]), Halogen_HTML_Elements.div([Halogen_Util.classProp("condproj-picker")])([Halogen_HTML_Elements.div([Halogen_Util.classProp("condproj-proj-picker")])([Halogen_HTML_Elements.select([Halogen_HTML_Events.onSelectedIndexChange(function () {
      var $30 = Data_Functor.map(Data_Maybe.functorMaybe)(SetBase.create);
      return function ($31) {
        return $30(indexToBase($31));
      };
    }())])(Data_Functor.mapFlipped(Data_Functor.functorArray)(intBaseProjections)(function (bp) {
      var isSelected = Data_Eq.eq(Corona_Chart.eqBase)(bp)(st.baseProjection);
    ...
    }))]), Halogen_HTML_Elements.div([Halogen_Util.classProp("condproj-cond-picker")])([Halogen_HTML_Elements.select([Halogen_HTML_Events.onSelectedIndexChange(function () {
      var $32 = Data_Functor.map(Data_Maybe.functorMaybe)(SetCond.create);
      return function ($33) {
        return $32(indexToCond($33));
      };
    }())])(Data_Functor.mapFlipped(Data_Functor.functorArray)(allCondType)(function (c) {
      ...
      return Halogen_HTML_Elements.option([Halogen_HTML_Properties.selected(isSelected)])([Halogen_HTML_Core.text(condString(c))]);
    }))]), Halogen_HTML_Elements.div([Halogen_Util.classProp("condproj-num-picker")])([Halogen_HTML_Elements.input([Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(Corona_Chart.conditionValue(st.condition))), Halogen_HTML_Events.onValueInput(function () {
      var $34 = Data_Functor.map(Data_Maybe.functorMaybe)(function ($36) {
        return SetLimit.create(Data_Int.round($36));
      });
      return function ($35) {
        return $34(Data_Number.fromString($35));
      };
    }())])])])]);
  };
...
(function ($PS) {
  ...
  $PS["Corona.Chart.UI.NumericOp"] = $PS["Corona.Chart.UI.NumericOp"] || {};
  var exports = $PS["Corona.Chart.UI.NumericOp"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Corona_Chart = $PS["Corona.Chart"];
  var D3_Scatter_Type = $PS["D3.Scatter.Type"];
  ...
  var ODelta = function () {
    ...
    ;
    ODelta.value = new ODelta();
    return ODelta;
  }();

  var OPGrowth = function () {
    function OPGrowth() {}

    ;
    OPGrowth.value = new OPGrowth();
    return OPGrowth;
  }();

  var OWindow = function () {
    function OWindow() {}

    ;
    OWindow.value = new OWindow();
    return OWindow;
  }();

  var SetOp = function () {
    function SetOp(value0) {
      this.value0 = value0;
    }

    ;

    SetOp.create = function (value0) {
      return new SetOp(value0);
    };
  ...
  var SetWindow = function () {
    function SetWindow(value0) {
      this.value0 = value0;
    }

    ;

    SetWindow.create = function (value0) {
      return new SetWindow(value0);
    };
  ...
  var initialState = function initialState(v) {
    return {
      currentOp: ODelta.value,
      windowSize: 1
    };
  };

  var eqNumericOp = new Data_Eq.Eq(function (x) {
    return function (y) {
      if (x instanceof ODelta && y instanceof ODelta) {
        return true;
      }

      ;

      if (x instanceof OPGrowth && y instanceof OPGrowth) {
        return true;
      }

      ;

      if (x instanceof OWindow && y instanceof OWindow) {
        return true;
      }
  ...
  var render = function render(st) {
    var parseWindow = function () {
      var $25 = Data_Functor.map(Data_Maybe.functorMaybe)(function () {
        var $27 = Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt);
        return function ($28) {
          return $27(Data_Int.round($28));
        };
      }());
      return function ($26) {
        return $25(Data_Number.fromString($26));
      };
    }();

    var indexToOp = function indexToOp(v) {
      if (v === 0) {
        return new Data_Maybe.Just(ODelta.value);
      }

      ;

      if (v === 1) {
        return new Data_Maybe.Just(OPGrowth.value);
      }

      ;

      if (v === 2) {
        return new Data_Maybe.Just(OWindow.value);
      }
    ...
    return Halogen_HTML_Elements.div([Halogen_Util.classProp("numeric-op")])(Data_Array.catMaybes([Data_Maybe.Just.create(Halogen_HTML_Elements.div([Halogen_Util.classProp("numeric-picker")])([Halogen_HTML_Elements.select([Halogen_HTML_Events.onSelectedIndexChange(function () {
      var $29 = Data_Functor.map(Data_Maybe.functorMaybe)(SetOp.create);
      return function ($30) {
        return $29(indexToOp($30));
      };
    }())])([Halogen_HTML_Elements.option([Halogen_HTML_Properties.selected(true)])([Halogen_HTML_Core.text("Daily Change")]), Halogen_HTML_Elements.option_([Halogen_HTML_Core.text("Percent Growth")]), Halogen_HTML_Elements.option_([Halogen_HTML_Core.text("Moving Average")])])])), function () {
      var $12 = Data_Eq.eq(eqNumericOp)(st.currentOp)(OWindow.value);

      if ($12) {
        return Data_Maybe.Just.create(Halogen_HTML_Elements.div([Halogen_Util.classProp("window-picker")])([Halogen_HTML_Core.text("Window size (before and after): "), Halogen_HTML_Elements.input([Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(st.windowSize)), Halogen_HTML_Events.onValueInput(function () {
          var $31 = Data_Functor.map(Data_Maybe.functorMaybe)(SetWindow.create);
          return function ($32) {
            return $31(parseWindow($32));
          };
        }())])]));
      }
  ...
  var assembleOp = function assembleOp(t0) {
    return Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
      if (st.currentOp instanceof ODelta) {
        return Type_DSum.dsum(D3_Scatter_Type.fromNType(t0))(new Corona_Chart.Delta(t0, Type_Equiv.refl));
      }

      ;

      if (st.currentOp instanceof OPGrowth) {
        return Type_DSum.dsum(D3_Scatter_Type.sPercent)(new Corona_Chart.PGrowth(t0, Type_Equiv.refl));
      }

      ;

      if (st.currentOp instanceof OWindow) {
        return Data_Exists.runExists(function (tf) {
          return Type_DSum.dsum(Corona_Chart.toFractionalOut(tf))(new Corona_Chart.Window(tf, st.windowSize));
        })(Corona_Chart.toFractional(t0));
      }

      ;
      throw new Error("Failed pattern match at Corona.Chart.UI.NumericOp (line 118, column 5 - line 123, column 28): " + [st.currentOp.constructor.name]);
    });
  };

  var handleAction = function handleAction(t0) {
    return function (act) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(function () {
        if (act instanceof SetOp) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
            var $15 = {};
        ...
        if (act instanceof SetWindow) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
            ...
            ;
            $19.windowSize = act.value0;
            return $19;
          });
        }

        ;
        throw new Error("Failed pattern match at Corona.Chart.UI.NumericOp (line 97, column 5 - line 99, column 54): " + [act.constructor.name]);
      }())(function () {
        return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(assembleOp(t0))(function (ds) {
          return Type_DSum.withDSum(ds)(function (t) {
            return function (v) {
  ...
  var handleQuery = function handleQuery(t0) {
    return function (v) {
      return Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(function ($33) {
        return Data_Maybe.Just.create(v.value0($33));
      })(assembleOp(t0));
    };
  };

  var component = function component(t0) {
    return Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
      "eval": Halogen_Component.mkEval({
...
(function ($PS) {
        ...
        return function (v) {
          return v.typeMatch(function (tActual) {
            return function (sq) {
              ...
              if (v1 instanceof Data_Maybe.Nothing) {
                return Control_Applicative.pure(dictApplicative)(v.typeMismatch(Data_Exists.mkExists(tExpected)));
              }
              ...
              ;
              throw new Error("Failed pattern match at Halogen.ChainPicker (line 360, column 5 - line 362, column 39): " + [v1.constructor.name]);
            };
          });
        };
      };
  ...
  var someQuery = function someQuery(dictFunctor) {
    return function (t) {
      return function (q) {
        return {
          typeMismatch: Data_Either.Left.create,
  ...
  var showAssembleError = function showAssembleError(dictGShow) {
    return new Data_Show.Show(function (v) {
      ...
      ;
      throw new Error("Failed pattern match at Halogen.ChainPicker (line 282, column 12 - line 296, column 10): " + [v.constructor.name]);
    });
  };
      ...
      return function (t0) {
        return function (act) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(function () {
                ...
                return {
                  tagChain: Type_DSum.withDSum(st.tagChain)(function (v) {
                    return function (c) {
                      ...
                      ;
                      throw new Error("Failed pattern match at Halogen.ChainPicker (line 219, column 13 - line 223, column 16): " + [v1.constructor.name]);
                    };
                  })
                };
              });
                  ...
                  return function (c) {
                    return Type_Ap.withAp(Type_Chain.splitAt(act.value0.ix)(c))(function (xs) {
                      return function (ys) {
                          ...
                          return Type_Ap.withAp(ys.value0)(function (v1) {
                            return function (zs) {
                              return Data_Exists.runExists(function (tNew) {
                                ...
                                ;
                                throw new Error("Failed pattern match at Halogen.ChainPicker (line 247, column 21 - line 251, column 45): " + [v2.constructor.name]);
                        ...
                        ;
                        throw new Error("Failed pattern match at Halogen.ChainPicker (line 243, column 13 - line 253, column 18): " + [ys.constructor.name]);
                      };
                    });
                  };
                });
            ...
            ;
            throw new Error("Failed pattern match at Halogen.ChainPicker (line 209, column 5 - line 255, column 10): " + [act.constructor.name]);
          }())(function () {
            return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
              return Control_Bind.bindFlipped(Halogen_Query_HalogenM.bindHalogenM)(function ($111) {
                return Halogen_Query_HalogenM.raise(ChainUpdate.create($111));
              })(lastTag(t0));
            });
          });
        };
  ...
  var functorQuery = new Data_Functor.Functor(function (f) {
    return function (v) {
      return new AskSelected(function ($113) {
        return f(v.value0($113));
      });
    };
  });
  ...
  var applyQuery = new Control_Apply.Apply(function () {
    ...
    return function (v1) {
      return AskSelected.create(function (x) {
        return v.value0(x)(v1.value0(x));
      });
    };
  });
  ...
  var applicativeQuery = new Control_Applicative.Applicative(function () {
    ...
    return new AskSelected(function (v) {
      return x;
    });
  });
      ...
      var go = function go(v) {
        return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Halogen_Query_HalogenM.monadHalogenM)))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Except_Trans.monadExceptT(Halogen_Query_HalogenM.monadHalogenM))))(function (i) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Halogen_Query_HalogenM.monadHalogenM)))(Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Except_Trans.monadExceptT(Halogen_Query_HalogenM.monadHalogenM)))(function (v1) {
            ...
            })(someQuery(functorSubQuery)(v.tagIn)(new SQ(Control_Category.identity(Control_Category.categoryFn)))))))(function (res) {
              ...
              if (res instanceof Data_Maybe.Just && res.value0 instanceof Data_Either.Right) {
                return Type_DSum.withDSum(res.value0.value0)(function (t2) {
                  return function (r) {
                    ...
                    ;
                    throw new Error("Failed pattern match at Halogen.ChainPicker (line 334, column 13 - line 337, column 52): " + [v1.constructor.name]);
                  };
                });
              }

              ;
              throw new Error("Failed pattern match at Halogen.ChainPicker (line 330, column 7 - line 338, column 12): " + [res.constructor.name]);
            });
          });
        });
      };
        ...
        return function (t0) {
          return function (v) {
            return Data_Functor.mapFlipped(Halogen_Query_HalogenM.functorHalogenM)(assembleChain(dictGOrd)(t0))(function (v1) {
              ...
              if (v1 instanceof Data_Either.Right) {
                return new Data_Maybe.Just(v.value0(v1.value0));
              }

              ;
              throw new Error("Failed pattern match at Halogen.ChainPicker (line 304, column 43 - line 306, column 30): " + [v1.constructor.name]);
            });
          };
        };
      };
      ...
      return function (pickerMap) {
        return function (t0) {
          return function (s) {
            ...
            return Halogen_HTML_Elements.div_([Halogen_HTML_Elements.div([Halogen_Util.classProp("op-list")])(Data_Array.catMaybes(Data_Function.flip(Data_FunctorWithIndex.mapWithIndex(Data_FunctorWithIndex.functorWithIndexArray))(inList)(function (i) {
              return function (sT) {
              ...
              return Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_Newtype.unwrap(Data_Functor_Compose.newtypeCompose)(Type_DProd.runDProd(pickerMap)(lastOut)))(function (v) {
                ...
                }), Halogen_Util.classProp("add-op")])([Halogen_HTML_Core.text("Add Operation")]);
              });
              ...
              }), Halogen_Util.classProp("remove-op")])([Halogen_HTML_Core.text("Remove Operation")]);
            })]))]);
          };
        };
      };
      ...
      return function (picker) {
        return function (t0) {
          return Halogen_Component.mkComponent({
            ...
            "eval": Halogen_Component.mkEval({
              handleAction: handleAction(dictGOrd.GEq0().Decide0())(dictGShow)(t0),
  ...
  var wrappedComponent = function wrappedComponent(dictGOrd) {
    return function (dictGShow) {
      return function (picker) {
        return function (t0) {
          return Halogen_Util.hoistQuery(unSomeQuery(applicativeQuery)(dictGOrd.GEq0().Decide0())(t0))(component(dictGOrd)(dictGShow)(picker)(t0));
        };
      };
    };
  };
...
(function ($PS) {
  ...
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Corona_Chart = $PS["Corona.Chart"];
  var Corona_Chart_UI_DateOp = $PS["Corona.Chart.UI.DateOp"];
  var Corona_Chart_UI_NumericOp = $PS["Corona.Chart.UI.NumericOp"];
  var D3_Scatter_Type = $PS["D3.Scatter.Type"];
  var Data_Either = $PS["Data.Either"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Exists = $PS["Data.Exists"];
  ...
  var handleQuery = function handleQuery(v) {
    return Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(function ($64) {
      return Data_Maybe.Just.create(v.value0($64));
    })(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM));
  };

  var chainPicker = Halogen_ChainPicker.wrappedComponent(D3_Scatter_Type.gordSType)(D3_Scatter_Type.gshowSType)(function (t) {
    return Data_Functor_Compose.Compose(function () {
      var v = D3_Scatter_Type.toNType(t);

      if (v instanceof Data_Either.Left && v.value0 instanceof Data_Either.Left) {
        return Data_Maybe.Just.create({
          component: Halogen_Util.trimapComponent(Halogen_ChainPicker.functorSubQuery)(function () {
            var $65 = Type_Equiv.equivToF2(v.value0.value0);
            return function ($66) {
              return function (v1) {
                return new Corona_Chart_UI_DateOp.QueryOp(v1.value0);
              }($65($66));
            };
          }())(Control_Category.identity(Control_Category.categoryFn))(function (v1) {
            return v1.value0;
          })(Corona_Chart_UI_DateOp.component),
          initialOut: Data_Exists.mkExists(D3_Scatter_Type.sDays)
        });
      }
      ...
      if (v instanceof Data_Either.Right) {
        return Data_Maybe.Just.create({
          component: Halogen_Util.trimapComponent(Halogen_ChainPicker.functorSubQuery)(function (v1) {
            return new Corona_Chart_UI_NumericOp.QueryOp(v1.value0);
          })(Control_Category.identity(Control_Category.categoryFn))(function (v1) {
            return v1.value0;
          })(Corona_Chart_UI_NumericOp.component(v.value0)),
          initialOut: Data_Exists.mkExists(t)
        });
      }

      ;
      throw new Error("Failed pattern match at Corona.Chart.UI.Projection (line 156, column 7 - line 173, column 12): " + [v.constructor.name]);
    }());
  });
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(function () {
        if (act instanceof SetBase) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
            ...
            ;
            $37.projection = Data_Exists.runExists(Data_Function.flip(Corona_Chart.setBase)(st.projection))(act.value0);
            return $37;
          });
        }
            ...
            return Type_DSum.withDSum(dsp)(function (tOut) {
              return function (proj) {
                return Corona_Chart.withProjection(proj)(function (pr) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                  ...
                  })(Halogen_ChainPicker.someQuery(Halogen_ChainPicker.functorQuery)(tIn)(new Halogen_ChainPicker.AskSelected(Control_Category.identity(Control_Category.categoryFn)))))(function (qres) {
                      ...
                      return Type_DSum.withDSum(qres.value0.value0)(function (tNewOut) {
                        return function (chain) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                            ...
                            ;
                            $44.projection = Type_DSum.dsum(tNewOut)(Corona_Chart.projection({
                              base: pr.base,
                              operations: chain
                            }));
                            return $44;
                    ...
                    ;
                    throw new Error("Failed pattern match at Corona.Chart.UI.Projection (line 190, column 13 - line 198, column 16): " + [qres.constructor.name]);
                  });
                });
              };
            });
        ...
        if (act instanceof SetNumScale) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
            ...
            ;
            $50.numScale = act.value0;
            return $50;
          });
        }

        ;
        throw new Error("Failed pattern match at Corona.Chart.UI.Projection (line 181, column 5 - line 201, column 54): " + [act.constructor.name]);
      }())(function () {
        return Control_Bind.bindFlipped(Halogen_Query_HalogenM.bindHalogenM)(function ($67) {
          return Halogen_Query_HalogenM.raise(Update.create($67));
        })(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM));
      });
    };
  };

  var render = function render(label) {
    return function (aState) {
      var indexToNScale = function indexToNScale(v) {
        if (v === 0) {
          return new Data_Maybe.Just(function ($68) {
            return D3_Scatter_Type.Linear.create(Data_Either.Right.create($68));
          });
        }
      ...
      return Halogen_HTML_Elements.div([Halogen_Util.classProp("axis-options")])([Halogen_HTML_Elements.h3_([Halogen_HTML_Core.text(label)]), Halogen_HTML_Elements.div([Halogen_Util.classProp("base-projection")])([Halogen_HTML_Elements.span_([Halogen_HTML_Core.text("Base Projection")]), Halogen_HTML_Elements.select([Halogen_HTML_Events.onSelectedIndexChange(function () {
        var $69 = Data_Functor.map(Data_Maybe.functorMaybe)(SetBase.create);
        return function ($70) {
          return $69(indexToBase($70));
        };
        ...
        return function (spr) {
          return Corona_Chart.withProjection(spr)(function (pr) {
            ...
            })(chainPicker(tBase))(Data_Unit.unit)(function (v1) {
        ...
        return function (v) {
          ...
          if (v1 instanceof Data_Either.Right) {
            return Halogen_HTML_Elements.select([Halogen_HTML_Events.onSelectedIndexChange(function () {
              var $71 = Data_Functor.map(Data_Maybe.functorMaybe)(SetNumScale.create);
              return function ($72) {
                return $71(indexToNScale($72));
              };
          ...
          ;
          throw new Error("Failed pattern match at Corona.Chart.UI.Projection (line 124, column 11 - line 133, column 16): " + [v1.constructor.name]);
        };
      })])]);
    };
  };
...
(function ($PS) {
  ...
  var handleQuery = function handleQuery(v) {
    ...
    ;
    throw new Error("Failed pattern match at Halogen.MultiSelect (line 149, column 15 - line 152, column 76): " + [v.constructor.name]);
  };
  ...
  var handleAction = function handleAction(dictMonadEffect) {
    return function (v) {
      ...
      ;
      throw new Error("Failed pattern match at Halogen.MultiSelect (line 130, column 16 - line 146, column 55): " + [v.constructor.name]);
    };
  };
    ...
    return function (v) {
      ...
      if (Data_Boolean.otherwise) {
        var norm = function () {
          ...
          ;
          throw new Error("Failed pattern match at Halogen.MultiSelect (line 176, column 12 - line 178, column 55): " + [v2.constructor.name]);
        }();
      ...
      ;
      throw new Error("Failed pattern match at Halogen.MultiSelect (line 168, column 1 - line 171, column 15): " + [s.constructor.name, v.constructor.name]);
    };
  };
  ...
  exports._drawData = function (handleType, handleScale, typeX, typeY, svgdat, scatter) {
    ...
    return function () {
      ...
      var yAxis = function yAxis(g) {
        g.attr("transform", "translate(".concat(margin.left, ",0)")).call(d3.axisLeft(y).ticks(10, ",d")).call(function (g) {
...
(function ($PS) {
  ...
  var lookupScale = function lookupScale(st) {
    return function (ns) {
      ...
      ;
      throw new Error("Failed pattern match at Corona.Chart.UI (line 63, column 21 - line 66, column 41): " + [v.constructor.name]);
    };
  };
    ...
    return function (dat) {
      return function (act) {
        return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(function () {
          ...
          ;
          throw new Error("Failed pattern match at Corona.Chart.UI (line 177, column 5 - line 181, column 67): " + [act.constructor.name]);
        }())(function () {
    ...
    return function (dat) {
      return function (st) {
        ...
        return Halogen_HTML_Elements.div([Halogen_Util.classProp("ui-wrapper")])([Halogen_HTML_Elements.div([Halogen_Util.classProp("grid__col grid__col--5-of-5 plot-title")])([Halogen_HTML_Elements.h2_([Halogen_HTML_Core.text(title)])]), Halogen_HTML_Elements.div([Halogen_Util.classProp("grid__col grid__col--1-of-5 axis-y")])([Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          ...
          return "multiselect";
        }))(Data_Ord.ordUnit)(_multiselect)(Data_Unit.unit)(Halogen_MultiSelect.component(dictMonadEffect))(sel0)(function (v) {
...
PS["Main"].main();
},{"process":"../../../../.nvm/versions/node/v12.11.1/lib/node_modules/parcel/node_modules/process/browser.js"}],"../../../../.nvm/versions/node/v12.11.1/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../.nvm/versions/node/v12.11.1/lib/node_modules/parcel/src/builtins/hmr-runtime.js","../dist/app.js"], null)
